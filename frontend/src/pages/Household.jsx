             ...
             <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
               ...
               <div className="lg:col-span-2 bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
                 ...
                 <div className="space-y-4">
                   {members.map(m => (
                     <div key={m.id} className="flex items-center justify-between p-4 rounded-xl border border-slate-100 bg-slate-50">
                       ...
                       <div className="flex flex-col items-end">
                         ...
                         <span className="text-[10px] text-slate-400 mt-1">Joined {new Date(m.joined_at).toLocaleDateString()}</span>
                       </div>
                     </div>
                   ))}
                 </div>
